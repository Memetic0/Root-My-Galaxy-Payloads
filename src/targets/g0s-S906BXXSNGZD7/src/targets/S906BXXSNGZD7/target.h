...
#define BUILD_VARIANT_LABEL "S906BXXSNGZD7"
#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT "samsung/g0sxxx/essi:16/BP2A.250605.031.A3/S906BXXSNGZD7:user/release-keys"
#endif

/* ---- Kernel image layout (S906B GZD7, offsets auto-extracted from Image) ---- */
...
#define P0_KERNEL_PHYS_LOAD 0x80000000ULL        /* exact GZD7 sboot pre-slide kernel base (sboot analysis: 30x 0x80000000 qword, 0x0 0xa8000000; Image text_offset=0) */
...
#define ASHMEM_MISC_FOPS_OFF 0x0207e060ULL   /* &ashmem_misc.fops */
#define ASHMEM_FOPS_OFF      0x01b7f150ULL   /* &ashmem_fops           */
...
/* ---- Kernel data objects ---- */
#define INIT_TASK_OFF           0x01e8dd00ULL   /* init_task           */
#define ROOT_TASK_GROUP_OFF     0x02105080ULL   /* root_task_group     */
...
#define SELINUX_ENFORCING_OFF   0x02258d58ULL   /* selinux_state.enforcing */
 ...
 * is the one that killed exec of /data/local/tmp/ksud from the UMH-spawned
 ...
 * KernelSU UID-0 transitions, so all four are cleared. Addresses from
 * vmlinux.nm; offsets relative to KIMAGE_TEXT_BASE. */
...
#define KMALLOC_CACHES_OFF      0x01bc4b40ULL   /* kmalloc_caches      */
#define ANON_PIPE_BUF_OPS_OFF   0x019f4068ULL   /* anon_pipe_buf_ops   */
...
#define SYSTEM_UNBOUND_WQ_OFF 0x01e79e10ULL               /* GDB: &system_unbound_wq - KIMAGE_TEXT_BASE */
 ...
 * verified against the g0s (GZD7) vmlinux (unix_stream_sendmsg+344..432):
...
#define SLIDE_NFULNL_LOGGER_OFF        0x01e81380ULL
#define SLIDE_LOGGERS_0_1_OFF          0x01e812b0ULL   /* &loggers[0][1] */
#define SLIDE_RANDOM_BOOT_ID_DATA_OFF  0x0203e930ULL   /* &random_table[4].data */
#define SLIDE_INIT_TASK_OFF            INIT_TASK_OFF
#define SLIDE_ROOT_TASK_GROUP_OFF      ROOT_TASK_GROUP_OFF
#define SLIDE_SYSCTL_BOOTID_OFF        0x022fd391ULL   /* sysctl_bootid buffer */
