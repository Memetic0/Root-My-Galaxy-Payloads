...
| `g0s-S906BXXSNGZD7` | Galaxy S22+ `SM-S906B` | `5.10.237` | Confirmed working: full chain through the app (Shizuku mode) incl. Samsung DEFEX bypass, KernelSU late-load, and granted `su` |
